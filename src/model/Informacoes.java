...
public class Informacoes {
	...
	public void lerTxt() throws ParseException {
		...
		try { // ler o arquivos gera uma excessão, temos que tratar
				// Caminho do arquivo .txt, muda de usuário para usuário
				// São paulo#45.3#Caatinga#24/25/2009 --- Exemplo de infromção no txt
			File arquivo = new File("C:\\Users\\Bryan\\Documents\\NetBeansProjects\\APS\\APS\\src\\.txt\\teste.txt");
	...
	public String[] retornarLista() {
        ...
        public void inserirInformacao(Informacoes info) {
            try {
                FileWriter arquivo = new FileWriter("C:\\Users\\Bryan\\Documents\\NetBeansProjects\\APS\\APS\\src\\.txt\\teste.txt", true);
