...
public class Controller {
    ...
    */
    ...
    public Controller(boolean importar){ //Construtor
    	try {
    		informacoes = new Informacoes();
    		if (importar) informacoes.lerCsv(); //le o csv e pega as informações
    		else informacoes.lerTxt();  //le o txt e pega as informações
    ...
    public long doSelectionSort(int ordenarPor, int crescOuDecr) {
        if          ((ordenarPor == 1) && (crescOuDecr == 1)) {
            ...
            tempoGasto = selectionSort.ordenarDataDecre();
